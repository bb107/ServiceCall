...
NTSTATUS NTAPI NtProtectVirtualMemory(
	...
	return reinterpret_cast<NTSTATUS(NTAPI*)(HANDLE, PVOID, PULONG, ULONG, PULONG)>(RtlGetNtProcAddress("NtProtectVirtualMemory"))
...
NTSTATUS NTAPI NtQueryVirtualMemory(
	...
	return reinterpret_cast<NTSTATUS(NTAPI*)(HANDLE, PVOID, MEMORY_INFORMATION_CLASS, PVOID, ULONG, PULONG)>(RtlGetNtProcAddress("NtQueryVirtualMemory"))
